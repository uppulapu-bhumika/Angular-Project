...
SECRET_KEY = 'django-insecure-6$ci-^xa28_j(96y&#b%x#6)d*bav2&*x0bm!3jzew$h*0m*en'
...
DATABASES['default'] = dj_database_url.parse('mysql://root@localhost/my_database_45000')
